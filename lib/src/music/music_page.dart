              ...
              child: Row(
                ...
                children: [
                  ...
                  ValueListenableBuilder(
                    valueListenable: Injector.instance<AudioCubit>().hasInternet,
                ...
                builder: (context, state) {
                  return Column(
                    ...
                    children: [
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                spacing: 8.h,
                                children: [
                                  DetailTitleWidget(title: (state.song?.name ?? '').formatSongTitle, maxLines: 2),
                      ...
                      Padding(padding: EdgeInsets.symmetric(horizontal: 16.w), child: const MusicSeekBarWidget()),
                      SizedBox(height: 8.h),
                      Padding(padding: EdgeInsets.symmetric(horizontal: 16.w), child: const MusicTimeIndicatorWidget()),
